...
namespace WebApplication
{
    public class BundleConfig
    {
        ...
        private static void RegisterCharts(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/Scripts/Charts/Refurb").Include(
                "~/Scripts/Charts/Refurb.js"));
        }
        ...
        private static void RegisterLayout(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/AdminLTE/plugins/chartjs2/js").Include(
                                         "~/AdminLTE/plugins/chartjs2/Chart.bundle.min.js",
                                         "~/AdminLTE/plugins/chartjs2/Chart.PieceLabel.js"));
            ...
            // plugins | lodash
            bundles.Add(new ScriptBundle("~/AdminLTE/plugins/lodash/js").Include(
                                         "~/AdminLTE/plugins/lodash/lodash.min.js"));

            // plugins | lodash
            bundles.Add(new ScriptBundle("~/AdminLTE/plugins/jsrender/js").Include(
                                         "~/AdminLTE/plugins/jsrender/jsrender.min.js"));
