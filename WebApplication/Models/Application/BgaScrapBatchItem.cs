...
{
    public class BgaScrapBatchItem
    {
        [Key]
        [Required]
        [Display(Name = "Id")]
        ...
        [Required]
        [Display(Name = "Bga Scrap Batch")]
        public int BgaScrapBatchId { get; set; }


        [ForeignKey("BgaScrapBatchId")]
        public virtual BgaScrapBatch BgaScrapBatch { get; set; }
